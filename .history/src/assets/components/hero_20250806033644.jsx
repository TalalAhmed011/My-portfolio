    ...
    >
      ...
      <div className="relative max-w-6xl w-full flex flex-col md:flex-row items-center justify-between gap-10 z-10">
        ...
        <motion.div
          ...
          className="flex-1 relative flex justify-center md:justify-end pt-[89px]"
        >
          {/* Background circle */}
          <div className="absolute w-60 h-60 md:w-80 md:h-80 bg-[#cacbcfcb] rounded-full opacity-30 top-[76px] md:top-[60px] right-0 -z-10" />

          {/* Image */}
          <img
            src="/ff.png"
            alt="Talal Ahmed"
            className="w-full max-w-[150px] md:max-w-[250px] h-auto object-contain pt-[89px] drop-shadow-2xl"
          />
        </motion.div>
      </div>
    </section>
