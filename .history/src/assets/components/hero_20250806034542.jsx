...
<div className="absolute w-72 h-72 md:w-[22rem] md:h-[22rem] bg-[#cacbcfcb] rounded-full opacity-30 top-0 md:top-6 right-0 -z-10" />
          {/* Transparent Image */}
          <img
  src="/ff.png"
  alt="Talal Ahmed"
  className="w-full max-w-[180px] md:max-w-[300px] h-auto object-contain drop-shadow-2xl"
/>
