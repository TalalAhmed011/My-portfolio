  ...
  return (
    <footer className="bg-gray-100 py-6 px-6 md:px-16 flex flex-col md:flex-row justify-between items-center text-gray-700 text-sm">
      ...
      <div className="flex gap-4 items-center mx-3">
        <a
  href="https://mail.google.com/mail/?view=cm&fs=1&to=talal445678@gmail.com&su=Hi%20Talal&body=I%20saw%20your%20portfolio..."
  target="_blank"
...
>
  <Mail className="w-5 h-5 hover:text-blue-600" />
        ...
        <a href="https://github.com/TalalAhmed011" target="_blank" rel="noopener noreferrer">
          <Github className="w-5 h-5 hover:text-black" />
        </a>
        <a href="https://www.linkedin.com/in/raja-tallal-849368282" target="_blank" rel="noopener noreferrer">
