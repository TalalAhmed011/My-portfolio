...
const experiences = [
  {
    ...
    year: "2024",
    details: "Worked with senior engineers to design and enhance UI/UX layouts using React and HTML CSS.",
  },
  {
    ...
    <section id="studies-experience" className="bg-dark text-light py-20 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <h3 className="text-xl font-semibold mb-4 text-[#38BDF8]">Education</h3>
          ...
          <div>
            <h3 className="text-xl font-semibold mb-4 text-[#38BDF8]">Experience</h3>
