...
const projects = [
  ...
  {
    title: " Company Monthly File merger & Uploader ",
    description: "A Python Tkinter desktop app to merge and upload files into Oracle DB, with progress bars and date filters.",
    tech: ["Python", "Tkinter", "OracleDB", "pyodbc", "Threading", "tkcalendar"],
    link: "https://github.com/yourusername/-dat-file-merger" // Replace with your repo or demo link
  },
