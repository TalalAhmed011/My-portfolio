...
const Hero = () => {
  return (
    <section
      id="hero"
      className="relative overflow-hidden h-screen bg-[#0F172A] text-[#F1F5F9] flex justify-center px-8 pt-5 pb-0"
    >
      ...
      <div className="relative max-w-6xl w-full flex flex-col md:flex-row items-center justify-between gap-10 z-10">
        ...
        <motion.div
          ...
          className="flex-1 relative flex justify-center md:justify-end pt-[160px]"
        >
          {/* Background circle */}
          <div className="absolute w-60 h-60 md:w-80 md:h-80 bg-[#cacbcfcb] rounded-full pt-[150px] opacity-30 top-[76px] md:top-[60px] right-0 -z-10" />

          {/* Image */}
          <img
            src="/ff.png"
            alt="Talal Ahmed"
            className="w-full max-w-[150px] md:max-w-[250px] h-[1150px] object-contain  drop-shadow-2xl"
          />
        </motion.div>
      </div>
    </section>
