...
<div className="absolute w-60 h-60 md:w-80 md:h-80 bg-[#cacbcf] rounded-full opacity-30 top-0 md:top-10 right-0 -z-10" />

{/* Transparent Image */}
<img
  src="/f.png"
  alt="Talal Ahmed"
  className="w-full max-w-xs md:max-w-sm h-auto object-contain drop-shadow-2xl"
/>
