...
const projects = [
  ...
  {
  title: "Merge & Upload",
  description: "A desktop app for uploading, merging, and searching files, featuring Oracle database integration, date filtering, and real-time progress tracking.",
