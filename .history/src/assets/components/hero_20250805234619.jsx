    ...
    >
      ...
      <div className="relative max-w-6xl w-full flex flex-col md:flex-row items-center justify-between gap-10 z-10">
        ...
        >
          ...
          <div className="absolute w-72 h-72 md:w-66 md:h-66 bg-[#1E293B] rounded-full opacity-30 top-0 md:top-10 right-0 -z-10" />

          {/* Transparent Image */}
          <img
            src="/f.png" // update if your file name differs
            alt="Talal Ahmed"
