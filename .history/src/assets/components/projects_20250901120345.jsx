...
const projects = [
  ...
  {
  title: "IESCO Monthly DAT File Merger",
  description: "A desktop application built with Tkinter for uploading, merging, and searching monthly DAT files, featuring database integration, date filtering, and real-time progress tracking.",
