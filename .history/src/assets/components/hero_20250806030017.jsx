...
const Hero = () => {
  return (
    <section
      id="hero"
      className="relative overflow-hidden min-h-screen bg-[#0F172A] text-[#F1F5F9] flex items-center justify-center px-8 pt-5 pb-0 import React from "react";
/* eslint-disable no-unused-vars */
...
const Hero = () => {
  return (
    <section
      id="hero"
      className="relative overflow-hidden min-h-screen bg-[#0F172A] text-[#F1F5F9] flex items-center justify-center px-8 pt-5 pb-0"
    >
