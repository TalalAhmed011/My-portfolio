...
<div className="absolute top-0 right-0 mt-4 mr-4 bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl p-4 w-64 shadow-lg z-10">
  <h4 className="text-sm font-semibold text-white mb-2">Companies I've Worked With</h4>
