...
const projects = [
  ...
  {
  title: "Merge & Upload",
  description: "A desktop application  with oracle built with Tkinter for uploading, merging, and searching files, featuring database integration, date filtering, and real-time progress tracking.",
