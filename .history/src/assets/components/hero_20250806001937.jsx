...
const Hero = () => {
  return (
    <section
      id="hero"
      className="relative overflow-hidden min-h-screen bg-[#0F172A] text-[#F1F5F9] flex items-start justify-center px-6 pb-10"
    >
      ...
      {/* 🌟 Main Content */}
      <div className="relative max-w-6xl w-full flex flex-col md:flex-row items-start justify-between gap-10 z-10">
        {/* Left: Text Content */}
        <motion.div
        ...
        {/* Right: Transparent Image with Card, pushed to bottom by mt-auto */}
        <motion.div
          initial={{ opacity: 0, x: 30 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.8, ease: "easeOut", delay: 0.3 }}
          className="flex-1 relative flex justify-center md:justify-end mt-auto"
        >
          ...
          <img
            src="/ff.png"
            alt="Talal Ahmed"
            className="w-full max-w-[150px] md:max-w-[250px] h-auto object-contain drop-shadow-2xl"
          />
        </motion.div>
      </div>
    </section>
