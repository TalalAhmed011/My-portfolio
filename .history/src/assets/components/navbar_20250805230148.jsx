...
const Nav = () => {
  ...
  <img src="/lu.png" alt="Logo" className="w-18 h-12 object-contain" />
        ...
        <ul className="hidden md:flex space-x-8 text-sm">
          ...
          <li><a href="#about" className="hovertext-[#38BDF8]"> transition duration-300">About</a></li>
          <li><a href="#projects" className="hovertext-[#38BDF8]"> transition duration-300">Projects</a></li>
          <li><a href="#contact" className="hovertext-[#38BDF8]"> transition duration-300">Contact</a></li>
        </ul>
