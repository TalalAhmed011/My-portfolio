...
const Hero = () => {
  return (
    <section
  id="hero"
  className="relative overflow-hidden min-h-screen bg-[#0F172A] text-[#F1F5F9] flex items-center md:items-end justify-center px-6 pb-20"
>
      ...
      <div className="relative max-w-6xl w-full flex flex-col md:flex-row items-center justify-between gap-10 z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl font-light text-gray-300">
            A Frontend Developer crafting responsive, accessible, and
